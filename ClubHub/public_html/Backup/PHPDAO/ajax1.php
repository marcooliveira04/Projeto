        ...
        <div class="row">
          ...
          <div class="col-sm-8 col-sm-offset-2">
            <div class="thumbnail">
              ...
              <div class="alert alert-info">Select tables and views from your schema you want to create objects for. Then define how object will be named in singular and plural.</div>
